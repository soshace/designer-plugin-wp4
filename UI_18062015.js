...
var url = AjaxRequest.ajaxurl+"?action=wcla_config_json";
if(AjaxRequest.design_id==0){
    url=url+"&productid="+AjaxRequest.productid;
}
else{
    url=url+"&design_id="+AjaxRequest.design_id;  
}
 // designer.init(document.getElementById('canvas-container'), url, controlsUpdateHandler, null/*, placeOrderHandler*/, options);
 designer.init(document.getElementById('canvas-container'), url, controlsUpdateHandler, options);
