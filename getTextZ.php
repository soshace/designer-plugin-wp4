<?php
        ...
        function buildFontIndex() {
                ...
                $o = shell_exec("/usr/local/bin/convert -list font");
                $ph = array("\n  Font: ","\n    family: ","\n    style: ","\n    stretch: ","\n    weight: ","\n    glyphs: ");
                $to = array("\n",",",",",",",",",",");
        ...
        $temp_file = $path."/../../uploads/wcla/tmp/text_".time().".png";
        ...
        $line = $path.'/texteffect '.implode(" ", $params).' '.$temp_file;
        if ($isSlant) {
                $line = "/usr/local/bin/convert -pointsize ".$_GET["p"]." -font "
                        .$fn." -fill '".$color."'"
